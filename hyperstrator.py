    ...
    def run(self):
        ...
        while not self.shutdown_flag.is_set():
            ...
            # Received a command
                ...
                unknown_msg = [
                    x for x in request if x not in [
                        self.create_msg, self.request_msg, self.update_msg,
                        self.delete_msg
                    ]
                ]
