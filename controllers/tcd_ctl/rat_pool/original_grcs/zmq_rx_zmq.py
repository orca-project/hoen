...
# Title: Zmq Rx Zmq
# Generated: Tue Feb 12 16:23:16 2019
##################################################
...
class zmq_rx_zmq(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zmq Rx Zmq")
        ...
        self.destination_suffix = destination_suffix = 500
        ...
        # Blocks
        ##################################################
        self.zeromq_push_sink_0 = zeromq.push_sink(gr.sizeof_char, 1, destination_address, 100, False, -1)
        self.zeromq_pull_source_0 = zeromq.pull_source(gr.sizeof_gr_complex, 1, source_address, 100, False, -1)
        ...
        # Connections
        ##################################################
        self.connect((self.digital_ofdm_rx_0, 0), (self.zeromq_push_sink_0, 0))
...
def main(top_block_cls=zmq_rx_zmq, options=None):
