...
# Title: Zmq Usrp Sink
# Generated: Thu Nov 29 07:36:28 2018
##################################################
...
class zmq_usrp_sink(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Zmq Usrp Sink")
...
def main(top_block_cls=zmq_usrp_sink, options=None):
